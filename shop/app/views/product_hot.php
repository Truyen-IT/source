   ...
   <div class="breadcrumbs">
            ...
            <ol itemscope itemtype="http://schema.org/BreadcrumbList">
               ...
               <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                  ...
                  <span itemprop="name">San pham hot</span></a>
         ...
         <div class="grids">
            <div class="grids_in">
               ...
               <input type="submit" style="box-shadow: none;" class=" btn btn-sucsecss btn-sm"
                                            name="addcart" value="Đặt Hàng<?php echo $product['price_product']?>$">
               </div>
               <!-- <div class="price_old_new">
                  <div class="price">
                     <span class="news_price"><?php echo $product['price_product']?> </span>
                  </div>
               </div> -->
            </div>
         </div>
