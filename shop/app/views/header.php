        ...
        <div class="header_top_menu">
            <div class="header_top_menu_all">
                <div class="header_top">
                    <div class="bg_in">
                        <div class="logo">
                            <a href="<?php echo BASE_URL?>"><img src="<?php echo BASE_URL?>/public/images/logo12.png" width="250" height="100" alt="logohere.jpeg" /></a>
                        </div>
                        <nav class="menu_top">
                            <form class="search_form" action="<?php echo BASE_URL ?>/index/timkiem" method="POST">
                                <input class="searchTerm" name="key" placeholder="Nhập từ cần tìm..." />
                        ...
                        <div class="cart_wrapper">
                            <div class="cols_50">
                                ...
                                <div class="logo">
                            <a href="<?php echo BASE_URL?>"><img src="<?php echo BASE_URL?>/public/images/abcd.gif" width="250" height="100" alt="logohere.jpeg" /></a>
                        </div>
                            ...
                            <div class="cols_50">
                                <div class="hot_line_top">
                                <!-- <div class="logo">
                                <a href="<?php echo BASE_URL?>"><img src="<?php echo BASE_URL?>/public/images/abc.gif" width="250" height="100" alt="logohere.jpeg" /></a>
                                </div> -->
                                  <!-- //<span><b class="text-primary">Kính Chào Quý Khách</b></span> -->
                                    <br/>
                                    <span class="red"></span>
                                </div>
                            </div>
                        ...
                        <div class="search_top">
                            <div id='cssmenu'>
                                <ul>
                                    ...
                                    <li><a href='<?php echo BASE_URL?>/tintuc/tatca'>Tin tức</a>
                                    <ul>
                                    <?php 
                                    ...
                                    <li class=''><a href='https://www.facebook.com/truyen.phan.7161953'>Chat</a></li>
