<footer>
            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a href="https://www.facebook.com/truyen.phan.7161953/" class="fb"><img src="<?php echo BASE_URL?>/public/images/Fb.png">Facebook</a></li>
                           <li><a href="https://www.google.com.vn/?hl=vi" class="fb"><img src="<?php echo BASE_URL?>/public/images/Gg.png">Google</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline:0839607053</span>
                                    <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>truyenb1910323@student.ctu.edu.vn</a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>https://shop.com/</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
         ...
         <div class="clear"></div>
         <div class="copyright">
            <h4 class="tkw9999">&copy;  © Bản quyền thuộc về php. Designed by <a href="http://webextrasite.com/" rel="dofollow" target="_blank">Thiet Ke Web</a> Bởi <a href="http://webextrasite.com/">Phan Trí Truyện</a></h4>
         </div>
      </footer>
